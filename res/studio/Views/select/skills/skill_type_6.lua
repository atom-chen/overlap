...
if callBackProvider~=nil then
      panel:addClickEventListener(callBackProvider("skill_type_6.lua", panel, "onTch"))
end
...
s1:setPosition(377.2479, 965.9003)
s1:setScaleX(0.3000)
s1:setScaleY(0.3000)
...
layout:setPercentHeight(0.3553)
layout:setSize({width = 474.0000, height = 474.0000})
layout:setLeftMargin(140.2479)
layout:setRightMargin(135.7521)
layout:setTopMargin(131.0997)
layout:setBottomMargin(728.9003)
s1:setFlippedX(true)
...
local sk_icon = cc.Sprite:createWithSpriteFrameName("icon-common-skill-6.png")
...
--Create Sprite_1
cc.SpriteFrameCache:getInstance():addSpriteFrames("Resource/atlas/ui-game.plist")
local Sprite_1 = cc.Sprite:createWithSpriteFrameName("skill-teach-cloud.png")
Sprite_1:setName("Sprite_1")
Sprite_1:setTag(41)
Sprite_1:setCascadeColorEnabled(true)
Sprite_1:setCascadeOpacityEnabled(true)
Sprite_1:setPosition(481.6079, 1068.6690)
Sprite_1:setScaleX(0.9000)
Sprite_1:setScaleY(0.9000)
layout = ccui.LayoutComponent:bindLayoutComponent(Sprite_1)
layout:setPositionPercentX(0.6421)
layout:setPositionPercentY(0.8011)
layout:setPercentWidth(0.6840)
layout:setPercentHeight(0.4160)
layout:setSize({width = 513.0000, height = 555.0000})
layout:setLeftMargin(225.1079)
layout:setRightMargin(11.8921)
layout:setTopMargin(-12.1689)
layout:setBottomMargin(791.1689)
