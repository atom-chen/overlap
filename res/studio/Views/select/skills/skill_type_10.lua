...
if callBackProvider~=nil then
      panel:addClickEventListener(callBackProvider("skill_type_10.lua", panel, "onTc"))
end
...
s2:setPosition(196.5803, 476.5083)
s2:setScaleX(0.2500)
s2:setScaleY(0.2500)
s2:setRotationSkewX(9180.0000)
s2:setRotationSkewY(9180.0000)
...
layout:setPercentHeight(0.3546)
layout:setSize({width = 267.0000, height = 473.0000})
layout:setLeftMargin(63.0803)
layout:setRightMargin(419.9197)
layout:setTopMargin(620.9917)
layout:setBottomMargin(240.0083)
...
s1:setPosition(377.1442, 975.8585)
s1:setScaleX(0.3000)
s1:setScaleY(0.3000)
s1:setRotationSkewX(90.0000)
s1:setRotationSkewY(90.0000)
s1:setOpacity(0)
...
layout:setPercentHeight(0.3553)
layout:setSize({width = 474.0000, height = 474.0000})
layout:setLeftMargin(140.1442)
layout:setRightMargin(135.8558)
layout:setTopMargin(121.1415)
layout:setBottomMargin(738.8585)
s1:setFlippedX(true)
...
s3:setPosition(506.8613, 502.3728)
s3:setScaleX(0.2500)
s3:setScaleY(0.2500)
...
layout:setPercentHeight(0.2009)
layout:setSize({width = 267.0000, height = 268.0000})
layout:setLeftMargin(373.3613)
layout:setRightMargin(109.6387)
layout:setTopMargin(697.6272)
layout:setBottomMargin(368.3728)
...
Panel_2:setPosition(304.9169, 199.2484)
...
layout:setLeftMargin(304.9169)
layout:setRightMargin(445.0831)
layout:setTopMargin(1134.7520)
layout:setBottomMargin(199.2484)
...
local sk_icon = cc.Sprite:createWithSpriteFrameName("icon-common-skill-10.png")
sk_icon:setName("sk_icon")
sk_icon:setTag(152)
sk_icon:setCascadeColorEnabled(true)
sk_icon:setCascadeOpacityEnabled(true)
sk_icon:setPosition(234.4140, 210.1449)
...
layout:setLeftMargin(199.9140)
layout:setRightMargin(481.0860)
layout:setTopMargin(1089.3550)
layout:setBottomMargin(175.6449)
...
localFrame:setTween(true)
localFrame:setTweenType(0)
localFrame:setX(196.5803)
localFrame:setY(476.5083)
PositionTimeline:addFrame(localFrame)

result['animation']:addTimeline(PositionTimeline)
PositionTimeline:setNode(s2)
...
localFrame:setTween(true)
localFrame:setTweenType(0)
localFrame:setSkewX(9180.0000)
localFrame:setSkewY(9180.0000)
RotationSkewTimeline:addFrame(localFrame)

result['animation']:addTimeline(RotationSkewTimeline)
RotationSkewTimeline:setNode(s2)
...
localFrame:setTween(true)
localFrame:setTweenType(0)
localFrame:setX(506.8613)
localFrame:setY(502.3728)
PositionTimeline:addFrame(localFrame)

result['animation']:addTimeline(PositionTimeline)
PositionTimeline:setNode(s3)
...
localFrame:setTween(true)
localFrame:setTweenType(0)
localFrame:setX(304.9169)
localFrame:setY(199.2484)
PositionTimeline:addFrame(localFrame)
...
localFrame:setTween(true)
localFrame:setTweenType(0)
localFrame:setX(234.4140)
localFrame:setY(210.1449)
PositionTimeline:addFrame(localFrame)
