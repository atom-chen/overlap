...
if callBackProvider~=nil then
      panel:addClickEventListener(callBackProvider("skill_type_8.lua", panel, "onClick"))
end
...
local sk_icon = cc.Sprite:createWithSpriteFrameName("icon-common-skill-8.png")
