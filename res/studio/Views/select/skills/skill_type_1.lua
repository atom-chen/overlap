...
if callBackProvider~=nil then
      panel:addClickEventListener(callBackProvider("skill_type_1.lua", panel, "onClick"))
end
...
layout:setSize({width = 532.0000, height = 818.0000})
