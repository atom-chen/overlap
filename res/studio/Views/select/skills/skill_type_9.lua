...
if callBackProvider~=nil then
      panel:addClickEventListener(callBackProvider("skill_type_9.lua", panel, "onTc"))
end
...
s2:setPosition(245.8259, 475.9448)
s2:setScaleX(0.2500)
s2:setScaleY(0.2500)
s2:setRotationSkewX(180.0000)
s2:setRotationSkewY(180.0000)
s2:setColor({r = 84, g = 114, b = 193})
layout = ccui.LayoutComponent:bindLayoutComponent(s2)
layout:setPositionPercentX(0.3278)
layout:setPositionPercentY(0.3568)
layout:setPercentWidth(0.3560)
layout:setPercentHeight(0.3546)
layout:setSize({width = 267.0000, height = 473.0000})
layout:setLeftMargin(112.3259)
layout:setRightMargin(370.6741)
layout:setTopMargin(621.5552)
layout:setBottomMargin(239.4448)
...
s3:setPosition(555.2695, 453.4398)
s3:setScaleX(0.2500)
s3:setScaleY(0.2500)
...
layout:setPercentHeight(0.2009)
layout:setSize({width = 267.0000, height = 268.0000})
layout:setLeftMargin(421.7695)
layout:setRightMargin(61.2305)
layout:setTopMargin(746.5602)
layout:setBottomMargin(319.4398)
...
local sk_icon = cc.Sprite:createWithSpriteFrameName("icon-common-skill-9.png")
...
layout:setLeftMargin(199.4140)
layout:setRightMargin(480.5860)
layout:setTopMargin(1088.8550)
layout:setBottomMargin(175.1449)
...
localFrame:setTween(true)
localFrame:setTweenType(0)
localFrame:setX(245.8259)
localFrame:setY(475.9448)
PositionTimeline:addFrame(localFrame)
...
localFrame:setTween(true)
localFrame:setTweenType(0)
localFrame:setX(555.2695)
localFrame:setY(453.4398)
PositionTimeline:addFrame(localFrame)
...
cc.SpriteFrameCache:getInstance():addSpriteFrames("Resource/atlas/ui-common.plist")
localFrame:setTextureName("icon-common-skill-9.png")
