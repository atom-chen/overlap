...
if callBackProvider~=nil then
      panel:addClickEventListener(callBackProvider("skill_type_9.lua", panel, "onClick"))
end
...
local Sprite_1 = cc.Sprite:createWithSpriteFrameName("st-9.png")
...
layout:setSize({width = 532.0000, height = 823.0000})
