...
panel:setPosition(375.0000, 669.2678)
if callBackProvider~=nil then
      panel:addClickEventListener(callBackProvider("skill_type_5.lua", panel, "onClick"))
end
