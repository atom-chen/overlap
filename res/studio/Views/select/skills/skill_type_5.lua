...
if callBackProvider~=nil then
      panel:addClickEventListener(callBackProvider("skill_type_5.lua", panel, "onTc"))
end
...
local sk_icon = cc.Sprite:createWithSpriteFrameName("icon-common-skill-5.png")
...
localFrame:setTween(true)
localFrame:setTweenType(0)
localFrame:setX(822.4141)
localFrame:setY(1284.1480)
PositionTimeline:addFrame(localFrame)
...
result['animation']:addTimeline(RotationSkewTimeline)
RotationSkewTimeline:setNode(e2)
...
localFrame:setTween(true)
localFrame:setTweenType(0)
localFrame:setX(479.5739)
localFrame:setY(1072.7040)
PositionTimeline:addFrame(localFrame)
...
result['animation']:addTimeline(RotationSkewTimeline)
RotationSkewTimeline:setNode(e3)
...
cc.SpriteFrameCache:getInstance():addSpriteFrames("Resource/atlas/ui-common.plist")
localFrame:setTextureName("icon-common-skill-5.png")
