...
if callBackProvider~=nil then
      panel:addClickEventListener(callBackProvider("skill_type_4.lua", panel, "onTc"))
end
...
--Create s2
cc.SpriteFrameCache:getInstance():addSpriteFrames("Resource/atlas/ui-game.plist")
local s2 = cc.Sprite:createWithSpriteFrameName("word-cn-1.png")
s2:setName("s2")
s2:setTag(149)
s2:setCascadeColorEnabled(true)
s2:setCascadeOpacityEnabled(true)
s2:setPosition(223.5453, 484.1133)
s2:setColor({r = 65, g = 135, b = 110})
...
layout:setLeftMargin(196.0453)
layout:setRightMargin(498.9547)
layout:setTopMargin(822.8867)
layout:setBottomMargin(457.1133)
s2:setBlendFunc({src = 1, dst = 771})
panel:addChild(s2)

--Create s1
cc.SpriteFrameCache:getInstance():addSpriteFrames("Resource/atlas/ui-game.plist")
local s1 = cc.Sprite:createWithSpriteFrameName("word-cn-2.png")
s1:setName("s1")
s1:setTag(150)
...
layout:setPercentHeight(0.0405)
layout:setSize({width = 55.0000, height = 54.0000})
layout:setLeftMargin(354.8303)
layout:setRightMargin(340.1697)
layout:setTopMargin(829.0542)
layout:setBottomMargin(450.9458)
s1:setBlendFunc({src = 1, dst = 771})
panel:addChild(s1)

--Create s3
cc.SpriteFrameCache:getInstance():addSpriteFrames("Resource/atlas/ui-game.plist")
local s3 = cc.Sprite:createWithSpriteFrameName("word-cn-3.png")
s3:setName("s3")
s3:setTag(151)
s3:setCascadeColorEnabled(true)
s3:setCascadeOpacityEnabled(true)
s3:setPosition(534.6993, 483.5556)
s3:setColor({r = 84, g = 114, b = 193})
...
layout:setLeftMargin(506.6993)
layout:setRightMargin(187.3007)
layout:setTopMargin(822.9444)
layout:setBottomMargin(456.0556)
