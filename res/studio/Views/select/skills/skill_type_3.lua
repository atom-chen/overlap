...
if callBackProvider~=nil then
      panel:addClickEventListener(callBackProvider("skill_type_3.lua", panel, "onTc"))
end
...
--Create s1
cc.SpriteFrameCache:getInstance():addSpriteFrames("Resource/atlas/ui-game.plist")
local s1 = cc.Sprite:createWithSpriteFrameName("word-cn-1.png")
s1:setName("s1")
s1:setTag(124)
...
local sk_icon = cc.Sprite:createWithSpriteFrameName("icon-common-skill-3.png")
