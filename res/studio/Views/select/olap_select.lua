...
cc.SpriteFrameCache:getInstance():addSpriteFrames("Resource/atlas/ui-common.plist")
btn_travel:loadTextureNormal("btn-334-112-n.png",1)
cc.SpriteFrameCache:getInstance():addSpriteFrames("Resource/atlas/ui-common.plist")
...
btn_travel:setCapInsets({x = 15, y = 11, width = 304, height = 90})
...
--Create starcount
local starcount = ccui.Text:create()
starcount:ignoreContentAdaptWithSize(true)
starcount:setTextAreaSize({width = 0, height = 0})
starcount:setFontName("Resource/fonts/OverlapExt.ttf")
starcount:setFontSize(48)
starcount:setString([[6/24]])
starcount:setLayoutComponentEnabled(true)
starcount:setName("starcount")
starcount:setTag(59)
starcount:setCascadeColorEnabled(true)
starcount:setCascadeOpacityEnabled(true)
starcount:setAnchorPoint(0.0000, 0.5000)
starcount:setPosition(370.1300, 76.4151)
starcount:setTextColor({r = 242, g = 251, b = 254})
layout = ccui.LayoutComponent:bindLayoutComponent(starcount)
