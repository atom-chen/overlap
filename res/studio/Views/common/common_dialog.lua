...
--Create LO_Text_1
local LO_Text_1 = ccui.Text:create()
LO_Text_1:ignoreContentAdaptWithSize(false)
LO_Text_1:setFontSize(36)
LO_Text_1:setString([[1212]])
LO_Text_1:setTextHorizontalAlignment(1)
LO_Text_1:setTextVerticalAlignment(1)
LO_Text_1:setLayoutComponentEnabled(true)
LO_Text_1:setName("LO_Text_1")
LO_Text_1:setTag(165)
LO_Text_1:setCascadeColorEnabled(true)
LO_Text_1:setCascadeOpacityEnabled(true)
LO_Text_1:setVisible(false)
LO_Text_1:setPosition(260.0000, 101.0000)
LO_Text_1:setTextColor({r = 118, g = 115, b = 113})
layout = ccui.LayoutComponent:bindLayoutComponent(LO_Text_1)
layout:setPositionPercentXEnabled(true)
layout:setPositionPercentYEnabled(true)
layout:setPositionPercentX(0.5000)
...
content:addChild(LO_Text_1)

--Create LO_Text_2
local LO_Text_2 = ccui.Text:create()
LO_Text_2:ignoreContentAdaptWithSize(false)
LO_Text_2:setFontName("Resource/fonts/OverlapExt.ttf")
LO_Text_2:setFontSize(36)
LO_Text_2:setString([[1212]])
LO_Text_2:setTextHorizontalAlignment(1)
LO_Text_2:setTextVerticalAlignment(1)
LO_Text_2:setLayoutComponentEnabled(true)
LO_Text_2:setName("LO_Text_2")
LO_Text_2:setTag(330)
LO_Text_2:setCascadeColorEnabled(true)
LO_Text_2:setCascadeOpacityEnabled(true)
LO_Text_2:setPosition(260.0000, 101.0000)
LO_Text_2:setTextColor({r = 118, g = 115, b = 113})
layout = ccui.LayoutComponent:bindLayoutComponent(LO_Text_2)
layout:setPositionPercentXEnabled(true)
layout:setPositionPercentYEnabled(true)
layout:setPositionPercentX(0.5000)
layout:setPositionPercentY(0.5050)
...
layout:setTopMargin(-1.0000)
layout:setBottomMargin(1.0000)
content:addChild(LO_Text_2)

--Create btn_close
local btn_close = ccui.Button:create()
btn_close:ignoreContentAdaptWithSize(false)
cc.SpriteFrameCache:getInstance():addSpriteFrames("Resource/atlas/ui-common.plist")
btn_close:loadTextureNormal("btn-113-7.png",1)
cc.SpriteFrameCache:getInstance():addSpriteFrames("Resource/atlas/ui-common.plist")
btn_close:loadTexturePressed("btn-113-7.png",1)
cc.SpriteFrameCache:getInstance():addSpriteFrames("Resource/atlas/ui-common.plist")
btn_close:loadTextureDisabled("btn-113-7.png",1)
...
btn_close:setCapInsets({x = 15, y = 11, width = 83, height = 55})
...
layout:setPercentHeight(0.1959)
layout:setSize({width = 113.0000, height = 77.0000})
layout:setHorizontalEdge(1)
layout:setLeftMargin(266.0570)
layout:setRightMargin(284.9430)
layout:setTopMargin(269.3956)
layout:setBottomMargin(46.6044)
