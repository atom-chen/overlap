...
Image_1:setPosition(375.0000, 757.4801)
layout = ccui.LayoutComponent:bindLayoutComponent(Image_1)
layout:setPositionPercentXEnabled(true)
layout:setPositionPercentX(0.5000)
layout:setPositionPercentY(0.5678)
layout:setPercentWidth(0.6787)
layout:setPercentHeight(0.4663)
layout:setSize({width = 509.0000, height = 622.0000})
layout:setLeftMargin(120.5000)
layout:setRightMargin(120.5000)
layout:setTopMargin(265.5199)
layout:setBottomMargin(446.4801)
...
Panel_7:setPosition(226.9669, 778.8141)
layout = ccui.LayoutComponent:bindLayoutComponent(Panel_7)
layout:setPositionPercentX(0.3026)
...
layout:setLeftMargin(226.9669)
layout:setRightMargin(223.0331)
layout:setTopMargin(505.1859)
layout:setBottomMargin(778.8141)
...
Panel_7_0:setPosition(226.9669, 706.1476)
...
layout:setLeftMargin(226.9669)
layout:setRightMargin(223.0331)
layout:setTopMargin(577.8524)
layout:setBottomMargin(706.1476)
...
Panel_7_1:setPosition(227.4672, 636.6716)
...
layout:setSize({width = 300.0000, height = 50.0000})
layout:setHorizontalEdge(1)
layout:setLeftMargin(227.4672)
layout:setRightMargin(222.5328)
layout:setTopMargin(647.3284)
layout:setBottomMargin(636.6716)
...
lbl_level:setPosition(363.6000, 970.2182)
...
layout:setPositionPercentY(0.7273)
layout:setPercentWidth(0.1067)
layout:setPercentHeight(0.0420)
layout:setSize({width = 80.0000, height = 56.0000})
layout:setLeftMargin(323.6000)
layout:setRightMargin(346.4000)
layout:setTopMargin(335.7818)
layout:setBottomMargin(942.2182)
...
panel_skill:setPosition(375.9000, 556.8346)
...
layout:setLeftMargin(225.9000)
layout:setRightMargin(224.1000)
layout:setTopMargin(737.1654)
layout:setBottomMargin(516.8346)
