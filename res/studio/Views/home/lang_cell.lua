...
lbl_lang:ignoreContentAdaptWithSize(false)
lbl_lang:setFontName("")
lbl_lang:setFontSize(36)
...
layout:setPercentWidth(1.0714)
layout:setPercentHeight(0.2345)
layout:setSize({width = 150.0000, height = 34.0000})
layout:setLeftMargin(-10.0833)
layout:setRightMargin(0.0833)
layout:setTopMargin(93.3077)
layout:setBottomMargin(17.6923)
