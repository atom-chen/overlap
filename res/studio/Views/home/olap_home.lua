...
btn_photo:setCascadeColorEnabled(true)
btn_photo:setCascadeOpacityEnabled(true)
btn_photo:setPosition(90.0000, 1280.8840)
btn_photo.UserData = {}
btn_photo.UserData[1] = [==========[sb]==========]
if callBackProvider~=nil then
...
btn_back:loadTextureNormal("Resource/atlas/alpha.png",0)
btn_back:loadTexturePressed("Resource/atlas/alpha.png",0)
btn_back:loadTextureDisabled("Resource/atlas/alpha.png",0)
btn_back:setTitleFontSize(14)
btn_back:setTitleColor({r = 65, g = 65, b = 70})
btn_back:setScale9Enabled(true)
btn_back:setCapInsets({x = 0, y = 0, width = 1, height = 1})
...
btn_back:setPosition(665.8995, 1281.6980)
btn_back.UserData = {}
btn_back.UserData[1] = [==========[sb]==========]
if callBackProvider~=nil then
      btn_back:addClickEventListener(callBackProvider("olap_home.lua", btn_back, "onClick"))
end
layout = ccui.LayoutComponent:bindLayoutComponent(btn_back)
layout:setPositionPercentX(0.8879)
layout:setPositionPercentY(0.9608)
layout:setPercentWidth(0.1333)
layout:setPercentHeight(0.0750)
layout:setSize({width = 100.0000, height = 100.0000})
layout:setHorizontalEdge(1)
layout:setVerticalEdge(2)
layout:setLeftMargin(615.8995)
layout:setRightMargin(34.1005)
layout:setTopMargin(2.3025)
layout:setBottomMargin(1231.6980)
panelPhoto:addChild(btn_back)

--Create Sprite_1
cc.SpriteFrameCache:getInstance():addSpriteFrames("Resource/atlas/ui-home.plist")
local Sprite_1 = cc.Sprite:createWithSpriteFrameName("btn-main-eye-back.png")
Sprite_1:setName("Sprite_1")
Sprite_1:setTag(91)
Sprite_1:setCascadeColorEnabled(true)
Sprite_1:setCascadeOpacityEnabled(true)
